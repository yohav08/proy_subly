...
<body>
    ...
    <div class="container">
        <h2 class="text-black">Crear Administrador</h2>
        <form action="./crearAdmin.php" method="GET" class="row g-3">
        <div style="padding: 10px 350px 20px;">

            <div class="mb-3">
                <label for="txt_id" class="form-label">Identificación</label>
                <input type="text" class="form-control" name="txt_id" placeholder="Digite número de identificación" required>
            </div>
            <div class="mb-3">
                <label for="txt_nombre" class="form-label">Nombre</label>
                <input type="text" class="form-control" name="txt_nombre"  placeholder="Digite nombre" required>
            </div> 
            <div class="mb-3">
                <label for="txt_correo" class="form-label">Correo</label>
                <input type="mail" class="form-control" name="txt_correo" placeholder="Digite correo" required>
            </div>
            <div class="mb-3">
                <label for="txt_clave" class="form-label">Clave</label>
                <input type="password" class="form-control" name="txt_clave" placeholder="Digite contraseña" required>
            </div>
            <center>
            <input type="submit" value="Crear Administrador" class="btn btn-primary">
            </center>
        </div>
        </form>
    </div>
