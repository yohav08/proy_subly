...
<head>
    ...
    <body>
        ...
        <!-- Seccion Principal Modulo Clientes-->
        <div class="container">
            <h2 class="text-black mt-3">Categorías</h2>
            <div class="row g-3 mt-3">
                <div class="col-3">
                    <a class="btn btn-primary" href="./crear_categoria.php" role="button">Crear Categoría</a>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    <table class="table" style="border-radius: 30px;" >
                        ...
                        <?php
                            ...
                            foreach($res as $row){?>
                            <tr>
                                <th><?php echo $row['cod_tipo']?></th>
                                <th><?php echo $row['tipo']?></th>
                                <th>
                                    <!-- Eliminar Producto-->
                                    <a class="btn btn-danger" href="./eliminarCategoria.php?cod_tipo=<?php echo $row['cod_tipo']?>"><i class="bi bi-trash3"></i></a>
