...
<body>
    ...
    <div class="container">
        <h2 class="text-black">Crear Categorías</h2>
        <form action="./crearCategoria.php" method="GET" class="row g-3">
        <div style="padding: 10px 350px 20px;">

            <div class="mb-3">
                <label for="txt_codtipo" class="form-label">Código tipo de producto</label>
                <input type="text" class="form-control" name="txt_codtipo" placeholder="Digite número del tipo de categoría" required>
            </div>
            <div class="mb-3">
                <label for="txt_tipo" class="form-label">Nombre del tipo de producto</label>
                <input type="text" class="form-control" name="txt_tipo"  placeholder="Digite el nombre del tipo de categoría" required>
            </div> 
            <center>
