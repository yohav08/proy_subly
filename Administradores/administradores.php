...
<html lang="en">
    ...
    <body>
        ...
        <!-- Seccion Principal Modulo Administradores-->
        <div class="container">
            <h2 class="text-black mt-3">Administradores</h2>
            <div class="row g-3 mt-3">
                <div class="col-3">
                    <a class="btn btn-primary" href="./crear_admin.php" role="button">Crear Administrador</a>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col">
                    <table class="table" style="border-radius: 30px;" >
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <th> <!-- Modificar Administrador-->
                                    <a class="btn btn-secondary" href="./modificar_admin.php?id_admin=<?php echo $row['id_admin']?>" mr-2><i class="bi bi-pencil-square"></i></a>
                                </th> <!-- FIN Modificar Administrador-->
                            </tr>
                        </tbody>
                        <?php }?>
