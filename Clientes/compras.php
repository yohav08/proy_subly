                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <?php   
                            ...
                            if($sess=mysqli_fetch_array($admin)){
                                ...
                                ";
                            }else if($sess=mysqli_fetch_array($client)){
                                ...
                                $nombre = mysqli_query(conex(), "select nombre from cliente where id_cliente='$sess'")->fetch_row();
                                $correo = mysqli_query(conex(), "select correo from cliente where id_cliente='$sess'")->fetch_row();
                                    ...
                                    <form class='d-flex' style='margin: 10px;'>
                                        <div class='btn-group'>
                                            ...
                                            <div class='dropdown-menu dropdown-menu-right'>
                                                <button class='dropdown-item' type='button'> $nombre[0] </button>
                                                <button class='dropdown-item' type='button'> $correo[0] </button>
                                                <a style='text-decoration: none;' href='./modificar_cuenta.php?id_cliente=".$sess."'><button class='dropdown-item' type='button'>Editar Cuenta</button></a>
                                                <div class='dropdown-divider'></div>
                                                <a href='../index.php' style='text-decoration:none;'>
                                                    <button class='dropdown-item' type='button'>Salir</button>
                                                </a>
                ...
                <div class="col">
                    <table class="table" style="border-radius: 30px;" >
                        ...
                        <?php
                            ...
                            $res=consultar_Compras($id_cliente);
                            ...
                            <tr>
                                ...
                                <th><a class="btn btn-danger" href="./PDF.php?cod_compra=<?php echo $row['cod_compra']?>"><i class="bi bi-file-earmark-pdf"></i></a></th>
                            </tr>
                        </tbody>
                        <?php }?>
