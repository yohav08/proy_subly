...
<body>
    ...
    <div class="container">
        <h2 class="text-black mt-3 mb-3">Crear Compra</h2>
        <form action="./crearCompra.php" method="GET" class="row g-3">
            <div class="col-6">
                <?php 
                ...
                <input type="text" class="form-control" name="txt_fechaCompra" value="<?php echo $fechaActual; ?>" readonly>
            </div>
            <div class="col-6">
                <label for="txt_direccionCompra" class="form-label">Dirección</label>
                <input type="text" class="form-control" name="txt_direccionCompra" placeholder="Escriba la dirección de envío" required>
            </div>
            <div class="col-6">
                <label for="txt_ciudadCompra" class="form-label">Ciudad</label>
                <input type="text" class="form-control" name="txt_ciudadCompra" placeholder="Escriba la ciudad de envío" required>
            </div>
            <div class="col-6">
                <label for="txt_numTarjeta" class="form-label">Número de Tarjeta</label>
                <input type="text" class="form-control" name="txt_numTarjeta" placeholder="Escriba los números de su tarjeta" required>
            </div>
            <div class="col-6">
                <input type="text" style="visibility: collapse;" value="<?php echo $ses=$_SESSION['usuario'];?>" value class="form-control" name="id_cliente" placeholder="Escriba los números de su tarjeta" required>
            </div>
            <center>
                <input type="submit" value="Comprar Productos" class="btn btn-primary mt-3 mb-5">
            </center>
        </form>
    </div>
