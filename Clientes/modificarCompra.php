<?php
    ...
    $cod_compra=$_REQUEST['txt_cod'];
    $direccion=$_REQUEST['txt_direccionCompra'];
    $ciudad=$_REQUEST['txt_ciudadCompra'];
    $num_tarjeta=$_REQUEST['txt_numTarjeta'];

    $sql="update compra set direccion='$direccion',ciudad='$ciudad', 
    num_tarjeta='$num_tarjeta' where cod_compra=$cod_compra";
    ...
    <body>
        <?php
            ...
            <script type='text/javascript'>
                ...
                text :  'Compra modificada con éxito'
                }).then((result) => {
